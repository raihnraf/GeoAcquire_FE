...
- [x] **CRUD-03**: User can view parcel details in sidebar when clicked
...
- [x] **ANA-04**: Buffer radius circle visualized on map
- [x] **ANA-05**: Nearby parcels highlighted in blue
